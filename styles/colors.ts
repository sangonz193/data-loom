...
export const themes = {
  ...
  red: {
    light: {
      ...
      popover: "0 0% 100%", // hsl(0 0% 100%)
      "popover-foreground": "0 0% 3.9%", // hsl(0 0% 3.9%)
      primary: "0 72.2% 50.6%", // hsl(0 72.2% 50.6%)
      "primary-foreground": "0 85.7% 97.3%", // hsl(0 85.7% 97.3%)
      secondary: "0 0% 96.1%", // hsl(0 0% 96.1%)
      "secondary-foreground": "0 0% 9%", // hsl(0 0% 9%)
      muted: "0 0% 96.1%", // hsl(0 0% 96.1%)
      "muted-foreground": "0 0% 45.1%", // hsl(0 0% 45.1%)
      ...
      border: "0 0% 89.8%", // hsl(0 0% 89.8%)
      input: "0 0% 89.8%", // hsl(0 0% 89.8%)
      ring: "0 72.2% 50.6%", // hsl(0 72.2% 50.6%)
    },
  ...
  orange: {
    light: {
      ...
      primary: "24.6 95% 53.1%", // hsl(24.6 95% 53.1%)
      "primary-foreground": "60 9.1% 97.8%", // hsl(60 9.1% 97.8%)
      ...
      ring: "24.6 95% 53.1%", // hsl(24.6 95% 53.1%)
    },
    ...
    dark: {
      ...
      primary: "20.5 90.2% 48.2%", // hsl(20.5 90.2% 48.2%)
      "primary-foreground": "60 9.1% 97.8%", // hsl(60 9.1% 97.8%)
      ...
      destructive: "0 72.2% 50.6%", // hsl(0 72.2% 50.6%)
      "destructive-foreground": "60 9.1% 97.8%", // hsl(60 9.1% 97.8%)
      border: "12 6.5% 15.1%", // hsl(12 6.5% 15.1%)
      input: "12 6.5% 15.1%", // hsl(12 6.5% 15.1%)
      ring: "20.5 90.2% 48.2%", // hsl(20.5 90.2% 48.2%)
    },
  },
  ...
  blue: {
    ...
    dark: {
      ...
      "card-foreground": "210 40% 98%", // hsl(210 40% 98%)
  ...
  violet: {
    light: {
      ...
      primary: "262.1 83.3% 57.8%", // hsl(262.1 83.3% 57.8%)
      ...
      ring: "262.1 83.3% 57.8%", // hsl(262.1 83.3% 57.8%)
    ...
    dark: {
      ...
      primary: "263.4 70% 50.4%", // hsl(263.4 70% 50.4%)
      "primary-foreground": "210 20% 98%", // hsl(210 20% 98%)
      ...
      ring: "263.4 70% 50.4%", // hsl(263.4 70% 50.4%)
    },
  },
...
} satisfies Record<ColorId | "default", any>
